...
<script type="text/javascript">
    ...
    function toexcel(cxtj,f_cxfs,f_ksrq,f_jsrq) {
        if (f_cxfs=="0") {
            window.location.href = "/excel/getBillDetailExcel?cxtj="+cxtj+"&f_ksrq="+f_ksrq+"&f_jsrq="+f_jsrq;
//            $.ajax({
//                url: "/excel/getBillDetailExcel",
//                type: "post",
//                async: false,
...
//            });
            ...
            window.location.href = "/excel/getSalesDetailExcel?cxtj="+cxtj+"&f_ksrq="+f_ksrq+"&f_jsrq="+f_jsrq;
        }
    }
    function searchbyKh(){
        var cxtj=$('#khxx').val();
