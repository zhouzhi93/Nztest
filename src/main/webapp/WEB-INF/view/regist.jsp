...
<%--<div class="am-radius" style="width: 600px;position: absolute;right: 200px;top:50px;background-color: white;padding: 10px 10px 10px 10px;">--%>
    <div class="am-g">
    <header class="header"><h1>欢迎注册，常熟市农药管理平台!</h1></header>
    ...
    <form class="am-form am-form-horizontal" id="loginform" style="margin-top: 20px;">
        ...
        <div class="am-u-sm-8">
            ...
            <div class="am-form-group am-text-left">
                <div class="am-u-sm-2">&nbsp;</div>
                <div class="am-u-sm-4">
                    <button type="submit" id="submitBtn" data-am-loading="{spinner: 'circle-o-notch', loadingText: '注册中', resetText: 'loading'}" class="am-btn am-btn-danger am-btn-xs am-radius">注册</button>&nbsp;&nbsp;
