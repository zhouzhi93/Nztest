...
<div class="am-g">
    <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
        ...
        <div class="am-container">
            <div class="am-u-sm-7 am-u-md-7">拨入部门：<input class="am-radius am-form-field am-input-sm" id="csbm" readonly style="width: 140px;display:inline-block;" type="text" placeholder="选择拨入部门">
        ...
        <div class="am-container" style="margin-top: 10px;">
            <div class="am-u-sm-6 am-u-md-6">拨出部门：<input class="am-radius am-form-field am-input-sm" id="JhXx" readonly style="width: 140px;display:inline-block;" type="text" placeholder="选择拨出 部门">
            </div>
...
<div class="am-modal am-modal-no-btn" closeViaDimmer="false" tabindex="-1" id="chooseJhdiv">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <div class="am-container">
                <div class="am-u-sm-6 am-u-md-6 am-text-left" style="padding-left: 0;padding-right: 0;">
                    <input class="am-radius am-form-field am-input-sm" id="xskhOption" style="width: 160px;display:initial;" type="text" placeholder="输入供应商名称、字母">
            ...
            <div style="margin-top: 10px;height: 380px;" class="am-container  am-scrollable-vertical">
                <table class="am-table am-table-bordered am-table-centered"  >
                    ...
                    <tr>
                        ...
                        <th class="am-text-middle">进货时间</th>
                        <th class="am-text-middle">供应商名称</th>
...
<script type="text/javascript">
    ...
    function loadJhxx(gysbm){
        ...
        $.ajax({
            ...
            type: "post",
            async: false,
            data: {f_gysbm:gysbm,f_bmbm:f_bmbm, timeer: new Date() },
            success: function (data) {
                ...
                if(dataJson.length>0) {
                    ...
                    for(var i=0;i<dataJson.length;i++){
                        ...
                        if(html==""){
                            html="<tr>\n" +
                                ...
                                "                            <td class=\"am-text-middle\">"+row.F_CSMC+"</td>\n" +
                                "                            <td class=\"am-text-middle\">"+row.F_ZDRMC+"</td>\n" +
                                "                        </tr>"
                        }else{
                            html+="<tr>\n" +
                                "                            <td class=\"am-text-middle\">"+row.F_DJH+"</td>\n" +
                    ...
                    $('#jhtable').html(html);
                    $('#jhtable tr').click(function () {
                        var rowNum=$(this).index();
                        var $table=$(this).parent();
                        var gysmc=$table.find('tr:eq(' + (rowNum) + ')').find('td:eq(2)').text();
                        var djh=$table.find('tr:eq(' + (rowNum) + ')').find('td:eq(0)').text();
                        $('#JhXx').val(djh);
                        $('#JhXx').attr('djh',djh);
                        $('#sptable').html("");
                        $.ajax({
                                ...
                                if(dataJson.length>0) {
                                    ...
                                    for(var i=0;i<dataJson.length;i++){
                                        ...
                                        var rowhtml="<tr sptm='"+spjson.F_SPTM+"'>"
                                            ...
                                            +"<td class=\"am-text-middle\" onmouseover=\"GetFocus(this)\"><input type=\"text\" max=\"0\" value=\""+spjson.F_GJSL+"\" onblur=\"resum_row(this)\"/>"+spjson.F_JLDW+"</td>"
                                            +"<td class=\"am-text-middle\" onmouseover=\"GetFocus(this)\"><input type=\"text\" min=\"1\" value=\""+spjson.F_GJDJ+"\" onblur=\"resum_row(this)\" /></td>"
                                            +"<td class=\"am-text-middle\">"+spjson.F_GJJE+"</td>"
    ...
    function savebill(){
        ...
        $table.find('tr').each(function () {
            ...
            var sp="{\"sptm\":\""+sptm+"\",\"gjdj\":\""+spdj+"\",\"gjsl\":\""+gjsl+"\",\"pch\":\""+pch+"\",\"sgpch\":\""+sgpch+"\"}";
            if(spxx==""){
                spxx="["+sp;
            }else{
                spxx= spxx+","+sp;
