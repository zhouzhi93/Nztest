...
<body>
                ...
                <div>
                    <div class="am-container">
                        ...
                        <div class="am-u-sm-6 am-u-md-6 am-text-right">
                            <button type="button" class="am-btn am-btn-xs am-radius" onclick="loadGysxx(1,10,'')" style="border: 1px solid #0E90D2;background: white;color: #0E90D2;">刷新</button>
            ...
            <div class="am-modal-bd">
                <div style="margin-top: 10px;" class="am-container">
                    <form class="am-form am-form-horizontal" id="addkhform">
                        ...
                        <div class="am-form-group">
                            <label for="f_xkzh" class="am-u-sm-2 am-form-label">许可证</label>
                            <div class="am-u-sm-9">
                                <input type="number" class="am-form-field am-input-sm am-radius" id="f_xkzh" required placeholder="经营许可证（生产许可证）">
                            </div>
                            <div class="am-u-sm-end"></div>
                        </div>
                        <div class="am-form-group">
            ...
            <div class="am-modal-bd">
                <div style="margin-top: 10px;" class="am-container">
                    <form class="am-form am-form-horizontal" id="updatekhform">
                        ...
                        <div class="am-form-group">
                            <label for="xgf_xkzh" class="am-u-sm-2 am-form-label">许可证</label>
                            <div class="am-u-sm-9">
                                <input type="number" class="am-form-field am-input-sm am-radius" id="xgf_xkzh" required placeholder="经营许可证（生产许可证）">
                            </div>
                            <div class="am-u-sm-end"></div>
                        </div>
                        <div class="am-form-group">
    ...
    <script type="text/javascript">
                        ...
                        try {
                            ...
                            setTimeout(function () {
                                $.ajax({
                                    ...
                                    type: "post",
                                    async: false,
                                    data: { f_khmc: f_khmc, f_sjhm: f_sjhm,f_lxr:f_lxr, f_qydz: "", f_xxdz: "", f_bzxx: f_bzxx,cslx:0,f_xkzh:f_xkzh, timeer: new Date() },
                            ...
                            setTimeout(function () {
                                $.ajax({
                                    ...
                                    data: { f_khmc: f_khmc, f_sjhm: f_sjhm,f_lxr:f_lxr, f_qydz: "", f_xxdz: "", f_bzxx: f_bzxx,
                                            f_khbm:f_khbm,cslx:0,f_xkzh:f_xkzh, timeer: new Date() },
                                    success: function (data, textStatus) {
                                        if(data == "ok"){
                                            alertMsg("修改成功！");
                                        }
        ...
        function loadTable(pageIndex) {
            $('#pagebar').html("");
            var khxx=$('#gysoption').val();
            loadGysxx(pageIndex,10,khxx);
        }
        //加载客户
        function loadGysxx(pageIndex,pageSize,khxx){
            $.ajax({
                url: "/initialvalues/GetKhda",
                type: "post",
                async: false,
                data: {khxx:khxx,cslx:0,pageIndex:pageIndex,pageSize:pageSize, timeer: new Date() },
