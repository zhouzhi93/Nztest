...
<head>
    ...
    <title>云平台客户端V1-统计明细维护树</title>
    <meta name="description" content="云平台客户端V1-统计明细维护树">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('#firstTree').on('selected.tree.amui', function (event, data) {
                parent.tempckbm = data.target.id;
                parent.tempJb = (data.target.jb);
                window.parent.loadckdaxx(data.target.id);
            });
            ...
            $('#firstTree').on('disclosedFolder.tree.amui', function (event, data) {
                parent.tempckbm = data.id;
                parent.tempJb = (data.jb);
                window.parent.loadckdaxx(data.id);
            });
