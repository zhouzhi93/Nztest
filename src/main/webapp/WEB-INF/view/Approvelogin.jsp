...
<head>
    ...
    <title>农资流通监管平台</title>
    <meta name="description" content="农资流通监管平台">
...
<div class="am-radius" style="width: 400px;position: absolute;right: 200px;top:150px;background-color: white;padding: 10px 10px 10px 10px;">
    <header class="header"><h2>农资流通审核平台</h2></header>
    <form class="am-form am-form-horizontal" id="loginform">
        <div class="am-form-group">
            <label for="f_sjhm" class="am-u-sm-3 am-form-label">手机号</label>
            <div class="am-u-sm-9">
                <input type="number" class="am-form-field am-input-sm am-radius" id="f_sjhm" required placeholder="手机号">
            </div>
        </div>
        <div class="am-form-group">
            <label for="f_sjhm" class="am-u-sm-3 am-form-label">密码</label>
            <div class="am-u-sm-9">
                <input type="password" class="am-form-field am-input-sm am-radius" id="f_zykl" required placeholder="请设置6~16位字符">
            </div>
        </div>
            ...
            submit: function () {
                ...
                if (formValidity) {
                    try {
                        ...
                        setTimeout(function () {
                            $.ajax({
                                url: "/approve/checkLogin",
                                type: "post",
                                async: false,
                                data: { f_sjhm: f_sjhm, f_zykl: f_zykl, timeer: new Date() },
                                success: function (data, textStatus) {
                                    if (data == "ok") {
                                        window.location = "/approve/gotoApproves";
                                    }
                                    else {
                                        alert(data);
                                    }
