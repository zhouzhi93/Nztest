...
<head>
    ...
    <title>云平台供应商端V1-原料采集</title>
    <meta name="description" content="云平台供应商端V1-原料采集">
...
<div class="am-modal am-modal-no-btn" closeViaDimmer="false" tabindex="-1" id="newSpdiv">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd am-scrollable-vertical" style="min-height: 440px;" >
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var show= localStorage.getItem("showSpdivCg");//用户最后一次选择展示还是不展示商品选择
        if(show=="true"){
    ...
    function spdadivshow() {
        if($("#spdadiv").is(":hidden")){
            ...
            $("#spdadiv").show();
            $("#morespda").removeClass("am-icon-chevron-left").addClass("am-icon-chevron-right");
            localStorage.setItem("showSpdivCg", "true");
        }else{
            $("#spdadiv").hide();
            ...
            localStorage.setItem("showSpdivCg", "false");
        }
    }
    //判断table是否已经含有此商品
