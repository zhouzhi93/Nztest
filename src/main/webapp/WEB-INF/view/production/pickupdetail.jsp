...
<head>
    ...
    <title>云平台客户端V1-原料采集查询</title>
    <meta name="description" content="云平台客户端V1-原料采集查询">
    ...
    <div class="am-scrollable-horizontal" style="margin-top: 15px;">
        ...
        <table class="am-table am-table-bordered am-table-striped am-text-nowrap am-table-centered" id="mxtable" style="display: none;">
            ...
            <tr>
                ...
                <th class="am-text-middle">采购数量</th>
                <th class="am-text-middle">采购金额</th>
            </tr>
            </thead>
            ...
            <div style="margin-top: 10px;height: 380px;" class="am-container  am-scrollable-vertical">
                <table class="am-table am-table-bordered am-table-centered"  >
                    ...
                    <tr>
                        ...
                        <th class="am-text-middle">购进单价</th>
                        <th class="am-text-middle">购进数量</th>
                        <th class="am-text-middle">购进金额</th>
                    </tr>
                    </thead>
...
<script type="text/javascript">
    $(function (){
        var spgjList ='${spgjList}';
        if(spgjList.length==0){
            console.log('暂无销售数据');
        }else {
            var $spgjtable=$('#spgjtable');
            spgjList=JSON.parse(spgjList);
            var salehtml="";
                    ...
                    if (spgjList.length > 0) {
                        ...
                        for (var i = 0; i < spgjList.length; i++) {
                            ...
                            salehtml += "<tr>\n" +
                                ...
                                "                        <td class=\"am-text-middle\">" + spgj.F_GJDJ + "</td>\n" +
                                "                        <td class=\"am-text-middle\">"+spgj.F_GJSL+"</td>\n" +
                                "                        <td class=\"am-text-middle\">"+spgj.F_GJJE+"</td>\n" +
                                "                    </tr>";
                            zsl+=eval(spgj.F_GJSL);
                            zje+=eval(spgj.F_GJJE);
                        }
                        salehtml += "<tr>\n" +
                            "                        <td class=\"am-text-left\" colspan='7'>合计：</td>\n" +
                ...
                if(dataJson.length>0) {
                    ...
                    for(var i=0;i<dataJson.length;i++){
                        ...
                        var rowhtml="<tr sptm='"+spjson.F_SPTM+"'>"
                            ...
                            +"<td class=\"am-text-middle\">"+spjson.F_GJSL+"</td>"
