...
<body>
    <div class="am-g">
            <div class="am-form-inline">
                ...
                <button onclick="loadInfo()" class="am-btn am-btn-default am-btn-sm am-radius am-btn-danger">查询</button>
            </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(saleList.length>0) {
                    ...
                    if(cxms==0){
                        hjhtml+="<tr>\n" +
                            "                        <td class=\"am-text-left\" colspan='4'>合计：</td>\n" +
                            "                        <td class=\"am-text-right\">"+zsl.toFixed(1)+"</td>\n" +
                            "                        <td class=\"am-text-right\">"+zje.toFixed(1)+"</td>\n" +
                            "                        <td class=\"am-text-right\">"+zsj.toFixed(1)+"</td>\n" +
                            "                    </tr>";
                    }else {
                        hjhtml+="<tr>\n" +
                            "                        <td class=\"am-text-left\" colspan='7'>合计：</td>\n" +
                            "                        <td class=\"am-text-right\">"+zsl.toFixed(1)+"</td>\n" +
                            "                        <td class=\"am-text-right\"></td>\n" +
                            "                        <td class=\"am-text-right\">"+zje.toFixed(1)+"</td>\n" +
                            "                        <td class=\"am-text-right\">"+zsj.toFixed(1)+"</td>\n" +
                            "                    </tr>";
                    };
