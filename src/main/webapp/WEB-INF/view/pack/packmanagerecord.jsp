...
<head>
    ...
    <title>云平台客户端V1-包装物处置记录</title>
    <meta name="description" content="云平台客户端V1-包装物处置记录">
...
<div class="am-g">
    <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
        ...
        <div class="am-container am-">
            <div class="am-u-sm-7 am-u-md-7">部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门：<select data-am-selected id="bmbm"></select></div>
            <div class="am-u-sm-7 am-u-md-7">处置方式：<input class="am-radius am-form-field am-input-sm" id="czfs"style="width: 200px;display:inline-block;" type="text" placeholder="输入处置方式">
        ...
        <div class="am-modal-bd">
            <div class="am-container">
                <div class="am-u-sm-6 am-u-md-6 am-text-left" style="padding-left: 0;padding-right: 0;">
                    <input class="am-radius am-form-field am-input-sm" id="csoption" style="width: 160px;display:initial;" type="text" placeholder="输入客户名称、字母">
...
<script type="text/javascript">
            ...
            for(var i=0;i<spdalist.length;i++){
                var spda=spdalist[i];
                    ...
                    spdahtml+="<li>\n<div class=\"am-gallery-item\">\n" +
                        ...
                        "      <div class=\"am-gallery-desc\">价格：<span style=\"color:red;font-size: 1.5rem;\">"+spda.F_XSDJ+"元</span></div>\n" +
    ...
    function savebill(){
        var czfs=$('#czfs').val();
        if(czfs===undefined|| czfs.length<0){
            alertMsg('请先输入处置方式');
            return;
        }
        ...
        setTimeout(function(){
            $.ajax({
                url: "/packing/packingManageRecordBill",type: "post", async: false,
                data: {czfs:czfs,f_bmbm:$('#bmbm').val(),jsje:jsje,spxx:spxx,sub:1,timeer: new Date() },
    ...
    function searchSpda(){
        ...
        $.ajax({
            url: "/packing/packingGoods",type: "post",async: false,
