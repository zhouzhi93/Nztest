...
<head>
    ...
    <title>云平台客户端V1-包装物回收单</title>
    <meta name="description" content="云平台客户端V1-包装物单">
...
<div class="am-g">
    <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
        ...
        <div class="am-container am-">
            <div class="am-u-sm-7 am-u-md-7">部门：<select data-am-selected id="bmbm"></select></div>
            <div class="am-u-sm-7 am-u-md-7">客户：<input class="am-radius am-form-field am-input-sm" id="csbm" readonly style="width: 200px;display:inline-block;" type="text" placeholder="选择客户">
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < dataJson.length; i++){
                    var bmbmxx = dataJson[i];
                    bmbmHtml += "<option value='"+bmbmxx.F_BMBM+"'>"+bmbmxx.F_BMMC+"</option>";
                }
                $("#bmbm").html(bmbmHtml);
            },
    ...
    function savebill(){
        ...
        setTimeout(function(){
            $.ajax({
                url: "/packing/packingBill",
                type: "post",
                async: false,
                data: {csbm:csbm,f_bmbm:$('#bmbm').val(),jsje:jsje,spxx:spxx,sub:1,timeer: new Date() },
                success: function (data) {
                    if(data=="ok"){
                        alertMsg("保存成功！");
                        clearpage();
