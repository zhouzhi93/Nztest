            ...
            <ul class="am-list admin-sidebar-list">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-jinhuo">
                        ...
                        <li><a href="JavaScript:void(0)" onclick="checkTab(this,'/purchase/purchasereturnbill')" class="am-cf"><span class="am-icon-check"></span>商户查询<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
                    </ul>
                </li>
                <li class="admin-parent">
