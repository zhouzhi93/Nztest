...
<div class="am-g">
    <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
        ...
        <div class="am-container" style="margin-top: 10px;">
            <div class="am-u-sm-12 am-u-md-12">原单据：<input class="am-radius am-form-field am-input-sm" id="JhXx" readonly style="width: 140px;display:inline-block;" type="text" placeholder="选择单据号">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function loadJhxx(gysbm){
        ...
        $.ajax({
            ...
            type: "post",
            async: false,
            data: {f_gysbm:gysbm, timeer: new Date() },
    ...
    function savebill(){
        ...
        $table.find('tr').each(function () {
            ...
            var sp="{\"sptm\":\""+sptm+"\",\"gjdj\":\""+spdj+"\",\"gjsl\":\""+gjsl+"\",\"pch\":\""+pch+"\"}";
            if(spxx==""){
                spxx="["+sp;
            }else{
                spxx= spxx+","+sp;
        ...
        setTimeout(function(){
            $.ajax({
                ...
                type: "post",
                async: false,
                data: {f_gysbm:csbm,f_ydjh:f_ydjh,yhje:yhje,jsje:jsje,spxx:spxx,timeer: new Date() },
                success: function (data) {
                    if(data=="ok"){
                        alertMsg("保存成功！");
                        clearpage();
    ...
    function qudingtuihuoshangping(){
        ...
        var flag=false;
        $table.find('tr').each(function () {
            var kcsl=$(this).find('td:eq(2)').text();
    ...
    function spimgclick(evnet){
        ...
        $.ajax({
            ...
            type: "post",
            async: false,
            data: {f_sptm:spjson.spbm,timeer: new Date() },
            success: function (data) {
