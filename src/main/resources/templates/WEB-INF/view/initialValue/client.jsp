                ...
                <div>
                    <div class="am-container">
                        ...
                        <div class="am-u-sm-6 am-u-md-6 am-text-right">
                            <button type="button" class="am-btn am-btn-xs am-radius" onclick="loadKhxx('')" style="border: 1px solid #0E90D2;background: white;color: #0E90D2;">刷新</button>
            ...
            <div class="am-modal-bd">
                <div style="margin-top: 10px;" class="am-container">
                    <form class="am-form am-form-horizontal" id="addkhform">
                        ...
                        <div class="am-form-group">
                            <label for="f_sfzh"  class="am-u-sm-2 am-form-label">证件号</label>
                            <div class="am-u-sm-9">
                                <input type="text" class="am-form-field am-input-sm am-radius" id="f_sfzh" placeholder="证件号">
                            </div>
                            <div class="am-u-sm-end"></div>
                        </div>
                        <div class="am-form-group">
                ...
                <div style="margin-top: 10px;" class="am-container">
                    <form class="am-form am-form-horizontal" id="updatekhform">
                        ...
                        <div class="am-form-group">
                            <label for="f_sfzh"  class="am-u-sm-2 am-form-label">证件号</label>
                            <div class="am-u-sm-9">
                                <input type="text" class="am-form-field am-input-sm am-radius" id="xgf_sfzh" placeholder="证件号">
                            </div>
                            <div class="am-u-sm-end"></div>
                        </div>
                        <div class="am-form-group">
    ...
    <script type="text/javascript">
                        ...
                        try {
                            ...
                            setTimeout(function () {
                                $.ajax({
                                    ...
                                    type: "post",
                                    async: false,
                                    data: { f_khmc: f_khmc, f_sjhm: f_sjhm,f_sfzh:f_sfzh, f_qydz: "", f_xxdz: "", f_bzxx: f_bzxx,cslx:1, timeer: new Date() },
                            ...
                            setTimeout(function () {
                                $.ajax({
                                    ...
                                    data: { f_khmc: f_khmc, f_sjhm: f_sjhm,f_sfzh:f_sfzh, f_qydz: "", f_xxdz: "", f_bzxx: f_bzxx,
                                            f_khbm:f_khbm,cslx:1, timeer: new Date() },
                                    success: function (data, textStatus) {
                                        if(data == "ok"){
                                            alertMsg("修改成功！");
                                        }
        ...
        function loadKhxx(khxx){
            $.ajax({
                ...
                type: "post",
                async: false,
                data: {khxx:khxx,cslx:1, timeer: new Date() },
