...
<div class="am-g">
    ...
    <div class="am-form-inline" style="margin-top: 10px;">
        进货日期:
        <input type="text" id="f_rq" class="am-form-field am-input-sm am-radius" style="width: 150px;" data-am-datepicker readonly placeholder="进货日期">&nbsp;&nbsp;&nbsp;&nbsp;
        查询方式:
