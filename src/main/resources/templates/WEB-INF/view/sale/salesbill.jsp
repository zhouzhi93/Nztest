    ...
    <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
            ...
            <div class="am-container">
                <div class="am-u-sm-7 am-u-md-7">客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户：<input class="am-radius am-form-field am-input-sm" id="khxx" readonly style="width: 140px;display:inline-block;" type="text" placeholder="选择客户">
            ...
            <div class="am-container" style="margin-top: 10px;">
                <div class="am-u-sm-12 am-u-md-12">商品条码：<input class="am-radius am-form-field am-input-sm" id="sptmScan"  style="width: 260px;display:inline-block;border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;  " type="text" placeholder=""></div>
            </div>
            ...
            <hr/>
            <div class="am-container">
                <div class="am-fl am-text-left" style="margin-top: 10px;margin-right: 10px;margin-bottom: 10px;">
                    付款方式：<select data-am-selected>
                    <option value="xj"selected>现金</option>
                    <option value="zfb" >支付宝</option>
                    <option value="wx">微信</option>
                </select>
                    <br>
                    <div style="margin-top:10px;">
                        实收金额：<input class="am-radius am-form-field am-input-sm" min="0" id="ssje" style="width: 160px;display:initial;" type="number"  value="0.00">元
                    </div>
                    <div style="margin-top:10px;">
                        找&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;零 ：<span id="zlje" style="color: #E72A33;">0.00</span> 元
                    </div>
                </div>
            ...
            <div class="am-container">
                <div class="am-fr">
                    <input style="vertical-align:middle;"  type="checkbox"/><span style="font-size: 13px;vertical-align:middle;">打印小票</span>
                    <button type="button" onclick="savebill()" class="am-btn am-btn-danger  am-radius am-btn-sm">开票</button></div>
            </div>
        </div>
        <!--商品档案选择-->
    ...
    <script type="text/javascript">
                           ...
                           var spJarr=JSON.parse(data);
                            ...
                            if(!flag){//如果不包含此商品
                                var rowhtml="<tr sptm='"+spjson.F_SPTM+"'>"
                                    ...
                                    +"<td class=\"am-text-middle\">"+eval(spjson.F_XSDJ)+"</td>"
        ...
        function savebill(){
            ...
            $table.find('tr').each(function () {
                ...
                var sp="{\"sptm\":\""+sptm+"\",\"spdj\":\""+spdj+"\",\"xssl\":\""+xssl+"\"}";
                if(spxx==""){
                    spxx="["+sp;
                }else{
                    spxx= spxx+","+sp;
            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    type: "post",
                    async: false,
                    data: {khbm:khbm,yhje:yhje,jsje:jsje,spxx:spxx,timeer: new Date() },
                    success: function (data) {
                        if(data=="ok"){
                            alertMsg('开票成功！')
                            clearpage();
