...
<div class="am-g">
    <div class="am-u-sm-12 am-u-md-12" id="xsdiv">
        ...
        <div class="am-container">
            <div class="am-u-sm-7 am-u-md-7">客;&nbsp;&nbsp;&nbsp;户：<input class="am-radius am-form-field am-input-sm" id="khxx" readonly style="width: 160px;display:inline-block;" type="text" placeholder="选择客户">
        ...
        <div class="am-container"  style="margin-top: 10px;">
            <div class="am-u-sm-12 am-u-md-12">原单据：<input class="am-radius am-form-field am-input-sm" id="saleXx" readonly style="width: 160px;display:inline-block;" type="text" placeholder="选择原单据">
                <%--<i class="iconfont icon-htmal5icon26" style="position: relative;left:-30px;vertical-align: middle;"></i>--%>
            </div>
        </div>
...
<div class="am-modal am-modal-no-btn" closeViaDimmer="false" tabindex="-1" id="chooseXsdiv">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <div class="am-container">
                <div class="am-u-sm-6 am-u-md-6 am-text-left" style="padding-left: 0;padding-right: 0;">
                    <input class="am-radius am-form-field am-input-sm" id="xskhOption" style="width: 160px;display:initial;" type="text" placeholder="输入客户名称、字母">
...
<script type="text/javascript">
    ...
    function savebill(){
        ...
        $table.find('tr').each(function () {
            ...
            var sp="{\"sptm\":\""+sptm+"\",\"spdj\":\""+spdj+"\",\"xssl\":\""+xssl+"\",\"pch\":\""+pch+"\"}";
            if(spxx==""){
                spxx="["+sp;
            }else{
                spxx= spxx+","+sp;
    ...
    //查询销售信息
    function loadSalexx(khxx){
        $.ajax({
            url: "/sales/saleZbxx",
            type: "post",
            async: false,
            data: {f_khxx:khxx, timeer: new Date() },
            success: function (data) {
                var dataJson = JSON.parse(data);
                if(dataJson.length>0) {
                    var html="";
                    for(var i=0;i<dataJson.length;i++){
                        ...
                        if(html==""){
                            html="<tr>\n" +
                                ...
                                "                            <td class=\"am-text-middle\">"+row.F_ZFJE+"</td>\n" +
                                "                            <td class=\"am-text-middle\">"+row.F_SYYMC+"</td>\n" +
                                "                            <td class=\"am-hide\">"+row.F_DJH+"</td>\n" +
                                "                        </tr>"
                        }else{
                            html+="<tr>\n" +
                                "                            <td class=\"am-text-middle\">"+row.F_RZRQ+row.F_XSSJ+"</td>\n" +
                    ...
                    $('#salestable tr').click(function () {
                        ...
                        var djh=$table.find('tr:eq(' + (rowNum) + ')').find('td:eq(4)').text();
                        $('#saleXx').val(djh);
                        $('#saleXx').attr('djh',djh);
                        $('#sptable').html("");
                        $.ajax({
